...
```{r}
anova(Pois1, test="Chi")$`Pr(>Chi)`[2]
anova(Pois1, GeneralPois1, test="Chi")$`Pr(>Chi)`[2]
anova(GeneralPois1, GeneralPois2, test="Chi")$`Pr(>Chisq)`[2]
1-pchisq(deviance(GeneralPois2), df.residual(GeneralPois2))
```
